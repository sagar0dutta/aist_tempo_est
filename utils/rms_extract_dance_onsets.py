...
def extract_anchor_energy(mode, markerA_id, savepath, aist2d_dir, fps= 60, h_thres = 0.2):
    ...
    for idx, filename in enumerate(tqdm(aist_filelist)):
        ...
        for ax in range(2):
            ...
            bodysegment_onsets_data = detect_energy_anchor(markerA_ax, T_filter=0.25, 
...
def detect_energy_anchor(sensor_data, T_filter=0.25, 
